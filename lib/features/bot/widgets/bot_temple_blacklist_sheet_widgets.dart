...
/// bot 圣殿黑名单下一页加载状态
class _BotTempleBlacklistLoadingMore extends StatelessWidget {
  /// 创建 bot 圣殿黑名单下一页加载状态
...
/// bot 圣殿黑名单下一页加载失败状态
class _BotTempleBlacklistLoadMoreError extends StatelessWidget {
  /// 创建 bot 圣殿黑名单下一页加载失败状态
  ///
  /// [onRetry] 加载下一页重试回调
  const _BotTempleBlacklistLoadMoreError({
