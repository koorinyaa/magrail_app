...
import 'package:magrail_app/features/temple/controller/latest_temple_page_controller.dart';
...
import 'package:magrail_app/features/temple/widgets/latest_temple_responsive_grid.dart';
import 'package:magrail_app/features/user/repository/user_repository.dart';

/// 最新圣殿二级页面
class LatestTemplePage extends StatefulWidget {
  /// 创建最新圣殿二级页面
  ///
  /// [key] Flutter 组件标识
  /// [repository] 圣殿仓库
  ...
  /// 创建最新圣殿二级页面状态
  @override
  State<LatestTemplePage> createState() => _LatestTemplePageState();
}

/// 最新圣殿二级页面状态
class _LatestTemplePageState extends State<LatestTemplePage> {
  late final LatestTemplePageController _controller;
  ...
  Widget build(BuildContext context) {
    return TinygrailPagedSliverPage(
      ...
      title: '最新圣殿',
      loadingSliver: const LatestTempleSkeletonGrid(),
  ...
  ///
  /// [item] 最新圣殿条目
  void _openCharacter(TempleApiItem item) {
    openCharacterDetail(
      context,
  ...
  ///
  /// [item] 最新圣殿条目
  void _openTempleAssetDialog(TempleApiItem item) {
    unawaited(
