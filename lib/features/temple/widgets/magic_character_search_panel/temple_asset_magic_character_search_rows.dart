...
/// 圣殿资产魔法道具搜索下一页加载状态
class _TempleAssetMagicSearchLoadingMore extends StatelessWidget {
  /// 创建圣殿资产魔法道具搜索下一页加载状态
  const _TempleAssetMagicSearchLoadingMore();
...
/// 圣殿资产魔法道具搜索下一页加载失败状态
class _TempleAssetMagicSearchLoadMoreError extends StatelessWidget {
  /// 创建圣殿资产魔法道具搜索下一页加载失败状态
  ///
  /// [onRetry] 加载下一页重试回调
  const _TempleAssetMagicSearchLoadMoreError({
